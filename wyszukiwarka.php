...
if (isset($_GET['submit'])){
    $conn=new  mysqli("localhost", "root", "", "poprawa");
    mysqli_select_db($conn,'poprawa') or die(mysqli_error());
    $keyword = "";
    if(isset($_GET['word'])) {
       $keyword = $_GET['word'];
    }
    print "Dane";
    $sql = "SELECT * FROM poprawa WHERE pesel LIKE '%$keyword%' OR pesel  LIKE '%$keyword%'";
